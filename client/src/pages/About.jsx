      ...
      <div className='max-w-2xl mx-auto p-3 text-center'>
        <div>
          ...
          <div className='text-md text-gray-500 flex flex-col gap-6'>
            <p>
              Welcome to Koushik&apos;s Blog! This blog was created by Koushik
              Ghavidel as a personal project to share his thoughts and ideas
              with the world. Koushik is a passionate developer who loves to
            ...
            <p>
              ...
              programming languages. Koushik is always learning and exploring
